...
import x.tui.launcher.managers.HTMLExtractManager;
import x.tui.launcher.managers.NotesManager;
...
import x.tui.launcher.managers.suggestions.SuggestionTextWatcher;
...
import x.tui.launcher.managers.xml.options.Suggestions;
import x.tui.launcher.managers.xml.options.Theme;
import x.tui.launcher.managers.xml.options.Toolbar;
import x.tui.launcher.managers.xml.options.Ui;
import x.tui.launcher.tuils.AllowEqualsSequence;
import x.tui.launcher.tuils.NetworkUtils;
import x.tui.launcher.tuils.OutlineEditText;
import x.tui.launcher.tuils.OutlineTextView;
import x.tui.launcher.tuils.Tuils;
import x.tui.launcher.tuils.interfaces.CommandExecuter;
import x.tui.launcher.tuils.interfaces.OnBatteryUpdate;
import x.tui.launcher.tuils.interfaces.OnRedirectionListener;
import x.tui.launcher.tuils.interfaces.OnTextChanged;
