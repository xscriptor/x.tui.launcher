...
import x.tui.launcher.commands.tuixt.TuixtActivity;
import x.tui.launcher.managers.ContactManager;
import x.tui.launcher.managers.RegexManager;
import x.tui.launcher.managers.TerminalManager;
import x.tui.launcher.managers.TimeManager;
import x.tui.launcher.managers.TuiLocationManager;
import x.tui.launcher.managers.notifications.KeeperService;
import x.tui.launcher.managers.notifications.NotificationManager;
import x.tui.launcher.managers.notifications.NotificationMonitorService;
import x.tui.launcher.managers.notifications.NotificationService;
import x.tui.launcher.managers.suggestions.SuggestionsManager;
import x.tui.launcher.managers.xml.XMLPrefsManager;
import x.tui.launcher.managers.xml.options.Behavior;
import x.tui.launcher.managers.xml.options.Notifications;
import x.tui.launcher.managers.xml.options.Theme;
import x.tui.launcher.managers.xml.options.Ui;
import x.tui.launcher.tuils.Assist;
import x.tui.launcher.tuils.CustomExceptionHandler;
import x.tui.launcher.tuils.LongClickableSpan;
import x.tui.launcher.tuils.PrivateIOReceiver;
import x.tui.launcher.tuils.PublicIOReceiver;
import x.tui.launcher.tuils.SimpleMutableEntry;
import x.tui.launcher.tuils.Tuils;
import x.tui.launcher.tuils.interfaces.Inputable;
import x.tui.launcher.tuils.interfaces.Outputable;
...
public class LauncherActivity extends AppCompatActivity implements Reloadable {
    ...
    private void finishOnCreate() {
        ...
        ContextCompat.registerReceiver(
                ...
                publicIOReceiver,
                filter1,
                "x.tui.launcher.permission.RECEIVE_CMD",
                null,
